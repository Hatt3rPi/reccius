...
<script>
    ...
    function carga_listado() {
        ...
        function format(d) {
            ...
            acciones += '<button class="accion-btn" title="WIP Generar Documento" id="' + d.id_acta + '" name="generar_documento_actaMuestreo" onclick="botones({analisisExterno:0, especificacion:this.id}, this.name, \'laboratorio\')"><i class="fa fa-file-pdf-o"></i></button><a> </a>';
