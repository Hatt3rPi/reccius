...
<body>
    <div id="form-container" class="ContenedorP">
        <div id="Maincontainer">
            ...
            <div class="footer-containerDIV" id="footer-containerDIV">
                <!-- Sección realizada por --><!-- Sección realizada por -->
                ...
                <div class="firma-section">
                    ...
                    <div class="firma-boxes">
                        ...
                        <p id='cargo_revisor' name='cargo_revisor' class="bold">Jefe de Producción</p>
                        <div class="signature">
                            <!-- acá debe ir el QR -->
                    ...
                    <div class="date-container">
                        <div id='fechaRevision' name='fechaRevision' class="date" style="display: none;">Fecha: dd/mm/yyyy</div>
                ...
                <div class="firma-section">
                    ...
                    <div class="date-container">
                        <div id='fechaAprobacion' name='fechaAprobacion' class="date" style="display: none;">Fecha: dd/mm/yyyy</div>
