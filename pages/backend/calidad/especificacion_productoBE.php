...
function procesarFormulario($link) {
    ...
    try {
        ...
        registrarTarea(7, $_SESSION['nombre'], $_POST['usuario_revisor'], 'Revisar especificación de producto: '.limpiarDato($_POST['documento']).' - versión:',limpiarDato($_POST['version']), 1, 'Firma especificación: Revisor');
        registrarTarea(14, $_SESSION['nombre'], $_POST['usuario_aprobador'], 'Aprobar especificación de producto: '.limpiarDato($_POST['documento']).' - versión:',limpiarDato($_POST['version']), 1, 'Firma especificación: Aprobador');
