...
<body>
            ...
            <fieldset>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <input type="text" name="prefijoDocumento" id="prefijoDocumento" readonly class="col" style="text-align: right; background-color: #e9ecef;width: 80%" readonly>
                            <input type="text" id="documento" name="documento" style="display: none">
                            <input type="text" id="numeroProducto" name="numeroProducto" placeholder="001" onchange="actualizarDocumento()" required class="col" style="width: 20px;margin-right: 150px;">
    ...
    <div id="notificacion" class="notificacion-container" style="display: none;">
        <span id="notificacion-mensaje">Mensaje de notificación</span>
    </div>
</body>
    ...
    function guardar() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (respuesta.exito) {
                    mostrarNotificacion('Especificación guardada con éxito', 'éxito');
                    ...
                    mostrarNotificacion('Error al guardar la especificación', 'error');
                    console.log(respuesta.mensaje); // Manejar el error
                }
            },
            error: function(xhr, status, error) {
