...
$queryCosto = "SELECT id, tipo_costo, detalle_costo, preparacion, detalle_preparacion, valor_clp, ultima_modificacion_fecha, ultima_modificacion_usuario FROM recetariomagistral_costosproduccion WHERE preparacion like '$preparacion%' AND detalle_preparacion like '$detalle%'";
