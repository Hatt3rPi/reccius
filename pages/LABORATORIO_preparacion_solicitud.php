            ...
            <fieldset>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input required id="numero_registro" class="form-control mx-0 w-90" name="numero_registro"
                            type="text" placeholder="DCAL-CC-ENE-001">
                    </div>
                    <div class="divider"></div> <!-- Esta es la línea divisora -->
                    <div class="form-group">
                        <label>Versión:</label>
                        <input id="version" name="version" type="text" class="form-control mx-0 w-90" value="1"
                            readonly>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input required id="numero_solicitud" class="form-control mx-0 w-90" name="numero_solicitud"
                            type="text" placeholder="SAEPT-0101001-00">
                    </div>
                    <div class="divider"></div> <!-- Esta es la línea divisora -->
                    <div class="form-group">
            ...
            <fieldset>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input class="form-control mx-0 w-90" id="tipo_producto" name="tipo_producto" type="text"
                            placeholder="Producto Terminado">
                    </div>
                    <div class="divider"></div> <!-- Esta es la línea divisora -->
                    <div class="form-group">
                        <label>Código Producto:</label>
                        <input class="form-control mx-0 w-90" id="codigo_producto" name="codigo_producto" type="text"
                            placeholder="12345">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input class="form-control mx-0 w-90" id="producto" name="producto" type="text"
                            placeholder="Ácido Ascórbico">
                    </div>
                    <div class="divider"></div> <!-- Esta es la línea divisora -->
                    <div class="form-group">
                        <label>Concentración:</label>
                        <input class="form-control mx-0 w-90" name="concentracion" id="concentracion" type="text"
                            placeholder="1g / 10 ml">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label>Formato:</label>
                        <input class="form-control mx-0 w-90" name="formato" id="formato" type="text"
                            placeholder="Ampolla">
                    </div>
                    <div class="divider"></div> <!-- Esta es la línea divisora -->
            ...
            <fieldset>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input required class="form-control mx-0 w-90 " name="lote" id="lote" type="text"
                            placeholder="RM-000000/00">
                    </div>
                    <div class="divider"></div> <!-- Esta es la línea divisora -->
                    <div class="form-group">
                        <label>Tamaño Lote:</label>
                        <input required class="form-control mx-0 w-90 " name="tamano_lote" id="tamano_lote" type="text"
                            placeholder="20">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input required class="form-control mx-0 w-90 datepicker " name="fecha_elaboracion"
                            id="fecha_elaboracion" value="<?php echo date('d/m/Y'); ?>" placeholder="dd/mm/aaaa"
                            type="text">
                    </div>
                    <div class="divider"></div> <!-- Esta es la línea divisora -->
                    <div class="form-group">
                        <label>Fecha Vencimiento:</label>
                        <input required class="form-control mx-0 w-90 datepicker " name="fecha_vencimiento"
                            id="fecha_vencimiento" placeholder="dd/mm/aaaa" type="text">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label>Tipo Análisis:</label>
                        <input required class="form-control mx-0 w-90 " name="tipo_analisis" id="tipo_analisis"
                            type="text" value="Análisis de rutina">
                    </div>
                    <div class="divider"></div>
                    <div class="form-group">
                        <label>Condiciones Almacenamiento:</label>
                        <textarea required class="form-control mx-0 w-90 border rounded-sm "
                            style="field-sizing: content;" name="condicion_almacenamiento" id="condicion_almacenamiento"
                            rows="2">T° ambiente, lugar fresco y seco, protegido de la luz</textarea>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label>Cantidad Muestra:</label>
                        <input required class="form-control mx-0 w-90 " name="tamano_muestra" id="tamano_muestra"
                            type="text" placeholder="...">
                    </div>
                    <div class="divider"></div> <!-- Esta es la línea divisora -->
                    <div class="form-group">
                        <label>Cantidad Contra-muestra:</label>
                        <input required class="form-control mx-0 w-90 " name="tamano_contramuestra"
                            id="tamano_contramuestra" type="text" placeholder="...">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label>Registro ISP:</label>
                        <input required class="form-control mx-0 w-90 " name="registro_isp" id="registro_isp"
                            type="text" value="N°2988/18. RF XIII 06/18. 1A, 2B, 2C, 3A, 3D, 4">
                    </div>
                    <div class="divider"></div> <!-- Esta es la línea divisora -->
                    <div class="form-group">
                        <label>Muestreado según POS:</label>
                        <input required class="form-control mx-0 w-90 " name="numero_pos" id="numero_pos" type="text"
                            value="DCAL-CC-PO-007">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group" id="contenedor_obsOriginal">
                        <label>Observaciones:</label>
                        <textarea name="form_observaciones" id="form_observaciones"
                            class="highlight form-control mx-0 w-90 border rounded-sm editable" rows="4"
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select required name="ejecutado_por" id="ejecutado_por"
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label>Verificador Muestreo:</label>
                        <select required name="am_verificado_por" id="am_verificado_por"
                            class="select-style mx-0 form__select w-90 ">
                            <option>Selecciona el usuario:</option>
                ...
                <fieldset>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select required name="laboratorio" id="laboratorio"
                                class="highlight select-style mx-0 form__select w-90 editable"
                                onchange="verificarOtro('laboratorio', 'otro_laboratorio')" style="width: 90%" required>
                            </select>
                            <input type="text" name="otro_laboratorio" id="otro_laboratorio"
                                placeholder="Especificar otro laboratorio"
                                class="highlight form-control mx-0 w-90 editable" style="display: none" />
                        </div>
                        <div class="divider"></div>
                        <!-- Esta es la línea divisora -->
                        <div class="form-group">
                            <label>Fecha Solicitud:</label>
                            <input name="fecha_solicitud" class="highlight form-control mx-0 w-90 datepicker editable"
                                id="fecha_solicitud" placeholder="dd/mm/aaaa" type="text" required />
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            <label>Análisis según:</label>
                            <input name="analisis_segun" id="analisis_segun"
                                class="highlight form-control mx-0 w-90 editable" type="text" required
                        ...
                        <div class="form-group">
                            ...
                            <input name="fecha_cotizacion" id="fecha_cotizacion" placeholder="dd/mm/aaaa" type="text"
                                required class="highlight form-control mx-0 w-90 datepicker editable" />
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            <label for="estandar_segun">Estándar Provisto por:</label>
                            <select required id="estandar_segun" name="estandar_segun"
                                class="highlight select-style mx-0 form__select w-90 editable" style="width: 82.5%">
                        ...
                        <div class="form-group">
                            ...
                            <input name="hds_otro" id="hds_otro" type="text" required
                                class="highlight form-control mx-0 w-90 editable" placeholder="No" />
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            <label>Fecha Entrega Estimada <em>(21 días corridos)</em>:</label>
                            <input name="fecha_entrega_estimada" id="fecha_entrega_estimada" placeholder="dd/mm/aaaa"
                                type="text" required class="highlight form-control mx-0 w-90 datepicker editable" />
                        </div>
                        <div class="divider"></div>
                        <!-- Esta es la línea divisora -->
                        <div class="form-group">
                            <label>N° Cotización:</label>
                            <input name="numero_documento" id="numero_documento"
                                class="highlight form-control mx-0 w-90 editable" type="text" required
                                placeholder="123456" />
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <label for="url_documento_adicional" id="url_documento_adicional_label"
                                class="label__like-input highlight w-90 d-flex">
                                <span>
                            ...
                            <input type="file" accept="application/pdf" id="url_documento_adicional"
                                name="url_documento_adicional" style="display: none;">
                        </div>
                    </div>
                </fieldset>
                <br />
                <fieldset>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input name="numero_especificacion" id="numero_especificacion" type="text"
                                placeholder="Numero de especificacion" class="form-control mx-0 w-90 " />
                        </div>
                        <div class="divider"></div>
                        <!-- Esta es la línea divisora -->
                        <div class="form-group">
                            <label>Versión:</label>
                            <input name="version_especificacion" id="version_especificacion" type="text"
                                placeholder="06-07-2023" class="form-control mx-0 w-90 " />
                        </div>
                    </div>
                </fieldset>
                <br />
                ...
                <fieldset>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input class="form-control mx-0 w-100 editable" type="text" id="usuario_editor"
                                name="usuario_editor" value="<?php echo $_SESSION['nombre']; ?>" readonly />
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select name="revisado_por" id="revisado_por"
                                class="select-style mx-0 form__select w-100 highlight editable" required>
