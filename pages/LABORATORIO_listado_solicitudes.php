...
<script>
    ...
    function carga_listado() {
        ...
        function format(d) {
            ...
            acciones += '<button class="accion-btn" title="WIP Generar Documento" id="' + d.id_acta + '" name="generar_documento_analisis" onclick="botones(this.id, this.name, \'laboratorio\')"><i class="fa fa-file-pdf-o"></i></button><a> </a>';
            return acciones;
        }
